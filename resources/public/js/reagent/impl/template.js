...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17383__auto__,writer__17384__auto__,opt__17385__auto__){
return cljs.core._write.call(null,writer__17384__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__18256 = o;
(G__18256[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__18257__delegate = function (args){
...
while (G__18258__i < G__18258__a.length) {G__18258__a[G__18258__i] = arguments[G__18258__i + 0]; ++G__18258__i;}
  args = new cljs.core.IndexedSeq(G__18258__a,0);
} 
return G__18257__delegate.call(this,args);};
G__18257.cljs$lang$maxFixedArity = 0;
G__18257.cljs$lang$applyTo = (function (arglist__18259){
var args = cljs.core.seq(arglist__18259);
return G__18257__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__16773__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__16773__auto__){
var and__16773__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__18265 = jsprops;
(G__18265["defaultValue"] = value);

(G__18265["onChange"] = ((function (G__18265,v,value,on_change){
return (function (p1__18262_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18262_SHARP_);
});})(G__18265,v,value,on_change))
);

(G__18265["ref"] = ((function (G__18265,v,value,on_change){
return (function (p1__18263_SHARP_){
return (this$["cljsInputElement"] = p1__18263_SHARP_);
});})(G__18265,v,value,on_change))
);
...
var vec__18270 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18270,(0),null);
var id = cljs.core.nth.call(null,vec__18270,(1),null);
var class$ = cljs.core.nth.call(null,vec__18270,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___18273 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___18273 == null)){
} else {
var key_18274 = temp__4429__auto___18273;
(jsprops["key"] = key_18274);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__18276 = (new reagent.impl.template.NativeWrapper());
(G__18276["name"] = c);
...
var len__17844__auto___18282 = arguments.length;
var i__17845__auto___18283 = (0);
while(true){
if((i__17845__auto___18283 < len__17844__auto___18282)){
args__17851__auto__.push((arguments[i__17845__auto___18283]));

var G__18284 = (i__17845__auto___18283 + (1));
i__17845__auto___18283 = G__18284;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__17852__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18280){
var G__18281 = cljs.core.first.call(null,seq18280);
var seq18280__$1 = cljs.core.next.call(null,seq18280);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__18281,seq18280__$1);
});
...
break;
default:
var G__18288 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__18288;
continue;
...
var n__17689__auto___18291 = a.length;
var i_18292 = (0);
while(true){
if((i_18292 < n__17689__auto___18291)){
(a[i_18292] = reagent.impl.template.as_element.call(null,(a[i_18292])));

var G__18293 = (i_18292 + (1));
i_18292 = G__18293;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17689__auto___18294 = a.length;
var i_18295 = (0);
while(true){
if((i_18295 < n__17689__auto___18294)){
var val_18296 = (a[i_18295]);
if((cljs.core.vector_QMARK_.call(null,val_18296)) && ((reagent.impl.template.key_from_vec.call(null,val_18296) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18295] = reagent.impl.template.as_element.call(null,val_18296));

var G__18297 = (i_18295 + (1));
i_18295 = G__18297;
continue;
} else {
}
...
var ctx = {};
var vec__18299 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__18299,(0),null);
var derefed = cljs.core.nth.call(null,vec__18299,(1),null);
...
var G__18301 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18301) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__18301){
